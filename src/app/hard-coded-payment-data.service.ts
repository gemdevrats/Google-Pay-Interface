...
export class HardCodedPaymentDataService {
  paymentData : Payment[] = [];
  constructor() {
    this.paymentData.push(new Payment('Pay','Sent','ADS4567543564588753465',2000,'You Paid',new Date('03/17/2021')));
    ...
    this.paymentData.push(new Payment('Collect','Sent','ADS456754356767879878',5000,'You Received',new Date('02/09/2022')));
